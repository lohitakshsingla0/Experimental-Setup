...
//     // Event listener for experiment topic change to populate chatbots
...
//     // Handle adding feedback questions
//     const addFeedbackQuestionBtn = document.getElementById('addFeedbackQuestion');
//     if (addFeedbackQuestionBtn) {
...
//             optionsContainer.className = 'options-container d-flex flex-wrap align-items-center gap-2';
...
//             addOptionButton.className = 'btn btn-outline-secondary btn-sm mr-2';
...
//                 dropdown.className = 'form-control mt-2';
...
//                 questionItem.appendChild(dropdown);
...
//             // Auto Add Two Options Initially
//             for (let i = 0; i < 2; i++) {
...
//                 text: question.querySelector('strong').textContent,
//                 options: Array.from(question.querySelectorAll('select option')).map(option => option.textContent),
//             }));
...
//             // If there are feedback forms, display the first one by default
//             if (data.feedbackForms.length > 0) {
//                 feedbackFormDropdown.dispatchEvent(new Event('change'));
//             } else {
//                 document.getElementById('feedbackFormDisplay').innerHTML = '<p>No feedback forms available.</p>';
//             }
//         });

//     // Event listener for feedback form selection
...
//         optionsList.className = 'list-group mt-2';
